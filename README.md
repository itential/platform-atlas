...
[![Build Status](https://github.com/itential/platform-atlas/actions/workflows/ci.yml/badge.svg)](https://github.com/itential/platform-atlas/actions/workflows/ci.yml)
[![License](https://img.shields.io/badge/License-GPL--3.0-blue.svg)](LICENSE)
[![GitHub release](https://img.shields.io/github/v/release/itential/platform-atlas)](https://github.com/itential/platform-atlas/releases)
-->
...
A brief description of what platform-atlas does and why it exists.
...
# Examples:
# pip install platform-atlas
# npm install -g platform-atlas
# brew install itential/tap/platform-atlas
# go install github.com/itential/platform-atlas@latest
```

### From Source

```bash
git clone https://github.com/itential/platform-atlas.git
cd platform-atlas
...
```bash
# Configure a device
platform-atlas configure --target router1.example.com --config network.yaml
...
- **Bug Reports**: [Open an issue](https://github.com/itential/platform-atlas/issues/new)
- **Questions**: [Start a discussion](https://github.com/itential/platform-atlas/discussions)
- **Maintainer**: [@cody-rester](https://github.com/cody-rester)
