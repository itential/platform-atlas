# Contributing to platform-atlas

Thank you for your interest in contributing to the platform-atlas project! This document provides guidelines and instructions for contributing to this project.
...
1. **Fork and clone the repository:**
   ```bash
   git clone https://github.com/YOUR-USERNAME/platform-atlas.git
   cd platform-atlas
   ```

2. **Add the upstream remote:**
   ```bash
   git remote add upstream https://github.com/itential/platform-atlas.git
   ```
...
Thank you for contributing to platform-atlas!
