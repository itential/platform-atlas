...
> **Important:** credentials are never stored in config files. At setup you choose one of three backends—**OS Keyring**, **Encrypted Local File**, or **HashiCorp Vault**—and Atlas retrieves secrets from there at runtime.
